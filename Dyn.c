...
{	
	...
	switch(kIndex){
		case 1: {	
					//показываем десятки первого индикатора
					DI_LED1_K1 = 0;
					#ifdef DI_LED1_K10
		...
		#ifdef DI_LED1_K100
		case 4: {	
					//показываем тысячи первого индикатора
					DI_LED1_K100 = 0;
					#ifdef DI_LED1_K1000
		...
		#ifdef DI_LED2_K1
		case 16: {	
					//показываем десятки второго индикатора
					DI_LED2_K1 = 0;
					#ifdef DI_LED2_K10
		...
		#ifdef DI_LED2_K100
		case 64: {	
					//показываем тысячи второго индикатора
					DI_LED2_K100 = 0;
					#ifdef DI_LED2_K1000
		...
		#endif
		#ifdef DI_LED2_K1000
		case 128: {	//перебор разрядов всех индикаторов закончен
					DI_LED2_K1000 = 0;
					Dyn_SignOut(DI_Digit[DI_p1][DI_LED1]);
					DI_LED1_K1 = 1;
					break;
